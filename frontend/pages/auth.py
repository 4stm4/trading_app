                ...
                html.Div(
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[html.Div('Войти', className='card-page-title'),]
                        ),
                        # форма для входа через почту или сотовый
                        html.Form(
                            children=[
                                html.Div(children=[
                                    html.Div('Эл. почта/номер телефона', className='bn-formItem-label'),
                                    html.Div(children=[
                                        html.Div(children=[
                                            dbc.Input(
                                ...
                                html.Button('Войти', className='next-button', id='auth-submit', n_clicks=0),
