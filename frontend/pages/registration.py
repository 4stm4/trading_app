                ...
                html.Div(
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[html.Div(signup[language]['welcome'], className='card-page-title'),]
                        ),
                        # форма для входа через почту или сотовый
                        html.Form(
                            children=[
                                html.Div(children=[
                                    html.Div(signup[language]['email_phone'], className='bn-formItem-label'),
                                    html.Div(children=[
                                        html.Div(children=[
                                            dbc.Input(
                                ...
                                html.Div(children=[
                                    html.Div(signup[language]['Password'] if 'Password' in signup[language] else 'Пароль', className='bn-formItem-label'),
                                    html.Div(children=[
                                        html.Div(children=[
                                            dbc.Input(
                                                class_name='bn-textField-input',
                                ...
                                html.Button(signup[language]['further'], className='next-button', id='register-submit', n_clicks=0),
                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.Div(signup[language]['Continue with Google'], className='company-label')
                                    ],
                                )
                            ]
                        ),
                        html.Div(
                            ...
                            children=[
                                ...
                                html.Div(signup[language]['Login'], className='oauth-enter-label-select'),
                            ]
                        )
                    ],
                )
